...
export default function HomePage() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#050507] flex flex-col">
      ...
      {/* ── Hero ── */}
      <main className="relative z-10 flex flex-col items-center justify-center flex-1 text-center px-6 pt-16 pb-32">
        <div
          className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-emerald-500/25 bg-emerald-500/5 text-emerald-400 text-xs font-medium tracking-wide mb-8"
        ...
        <h1 className="text-5xl sm:text-6xl md:text-7xl font-extrabold leading-[1.1] tracking-tight text-white max-w-4xl">
          Trade Smarter with{" "}
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mt-10">
          <button
            onClick={() => openModal("signup")}
            className="group relative px-7 py-3.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-white font-semibold text-base shadow-[0_0_30px_rgba(16,185,129,0.35)] hover:shadow-[0_0_40px_rgba(16,185,129,0.5)] transition-all overflow-hidden"
          >
          ...
          <button
            onClick={() => openModal("signin")}
            className="px-7 py-3.5 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-white font-semibold text-base transition-all"
            style={{ backdropFilter: "blur(8px)" }}
          >
            Sign In
          </button>
      ...
      {modalOpen && (
        ...
        >
          <div
            className="relative w-full max-w-md rounded-2xl border border-white/10 bg-[#0d0d12]/95 shadow-2xl shadow-black/60 p-8"
